...
import ModalAsignacion from './asignarServicio/ModalAsignacion';
import '../../../../styles/Servicios/Disponibilidad/EspaciosDisponibles/EspaciosDisponibles.css';

const EspaciosDisponibles = ({ employees, date, startHour, endHour, city }) => {
